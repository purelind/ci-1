...
REPO_URL = 'git@github.com:tikv/importer.git'
slackcolor = 'good'
githash = ""
...
def run_with_pod(arch, os, Closure body) {
    ...
    def pod_rust_docker_image = "hub.pingcap.net/jenkins/centos7_golang-1.13_rust-arm64:latest"
    def jnlp_docker_image = ""
    
    if (arch == "x86") {
        label = "importer-nightly-test"
    ...
    if (arch == "arm64") {
        label = "importer-nightly-test-arm64"
