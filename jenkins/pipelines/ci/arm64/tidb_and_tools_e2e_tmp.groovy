...
__EOF__
                ...
                stage('Start Clusters') {
                    ...
                    dir('cluster-cdc') {
                        ...
                        sh """
                        ../ticdc-linux-amd64/bin/cdc server --log-level=info --pd http://127.0.0.1:2379 &
                        ../ticdc-linux-amd64/bin/cdc cli changefeed create --pd http://127.0.0.1:2379 --sink-uri mysql://root@127.0.0.1:4001/?max-txn-row=5000
                        """
                    }
