    ...
    run_with_pod(arch, os) {
        ...
        stage("${arch} Prepare") {
            ...
            container("golang") {
                ...
                if (arch == "arm64") {
                    tikv_url = "${FILE_SERVER_URL}/download/builds/pingcap/tikv/${tikv_sha1}/centos7/tikv-server-linux-arm64.tar.gz"
                    tidb_url = "${FILE_SERVER_URL}/download/builds/pingcap/tidb/pr/${TIDB_COMMIT}/centos7/tidb-server-linux-arm64.tar.gz"
                    pd_url = "${FILE_SERVER_URL}/download/builds/pingcap/pd/${pd_sha1}/centos7/pd-server-linux-arm64.tar.gz"
                }
