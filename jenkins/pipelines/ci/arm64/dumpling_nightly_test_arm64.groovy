...
REPO_URL = 'git@github.com:pingcap/dumpling.git'
slackcolor = 'good'
githash = ""
...
def run_with_pod(arch, os, Closure body) {
    ...
    if (os == "kylin") {
        label = "dumpling-nightly-test-arm64-kylin"
...
def run_test(arch, os) {
    run_with_pod(arch, os) {
        ...
        stage("Checkout") {
            // update cache
            dir("go/src/github.com/pingcap/cdc") {
